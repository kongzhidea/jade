...
//        user.setUsername("kongzhihui");
    ...
    protected void _testUpdate() {
        User user = new User();
        user.setRealname("孔_1");
        user.setUsername("u_test_1");
        user.setCityName("北京");
...
//        user.setUsername("u_test_2");
//        Identity identity = userDAO.addUser2(user);
//        logger.info("id=" + identity.intValue());
