...
public interface UserDAO {
    ...
    Identity addUser2(@SQLParam("user") User user);
    ...
    // 执行的是batch方法，无法返回自增Id
    @SQL("insert into user(username,realname,privs,ctime,city_name) values" +
            "(:1.username,:1.realname,:1.privs,:1.ctime,:1.cityName) ")
    int[] addUserList(List<User> list); // 也可以@SQLParam("user")， :user.username
